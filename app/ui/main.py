...
info_rows = [
    ...
    {"指标代码": "rsi6_pct_1y", "中文名称": "RSI6-1Y%", "指标解释": "RSI6 在过去1年窗口内的历史百分位（0-100）"},
    {"指标代码": "rsi6_pct_2y", "中文名称": "RSI6-2Y%", "指标解释": "RSI6 在过去2年窗口内的历史百分位（0-100）"},
    {"指标代码": "rsi6_pct_3y", "中文名称": "RSI6-3Y%", "指标解释": "RSI6 在过去3年窗口内的历史百分位（0-100）"},
    {"指标代码": "rsi6_pct_4y", "中文名称": "RSI6-4Y%", "指标解释": "RSI6 在过去4年窗口内的历史百分位（0-100）"},
    {"指标代码": "rsi6_pct_all", "中文名称": "RSI6-ALL%", "指标解释": "RSI6 在全历史中的百分位（0-100）"},
    {"指标代码": "rsi12_pct_1y", "中文名称": "RSI12-1Y%", "指标解释": "RSI12 在过去1年窗口内的历史百分位（0-100）"},
    {"指标代码": "rsi12_pct_2y", "中文名称": "RSI12-2Y%", "指标解释": "RSI12 在过去2年窗口内的历史百分位（0-100）"},
    {"指标代码": "rsi12_pct_3y", "中文名称": "RSI12-3Y%", "指标解释": "RSI12 在过去3年窗口内的历史百分位（0-100）"},
    {"指标代码": "rsi12_pct_4y", "中文名称": "RSI12-4Y%", "指标解释": "RSI12 在过去4年窗口内的历史百分位（0-100）"},
    {"指标代码": "rsi12_pct_all", "中文名称": "RSI12-ALL%", "指标解释": "RSI12 在全历史中的百分位（0-100）"},
    {"指标代码": "value", "中文名称": "恐惧贪婪", "指标解释": "恐惧贪婪指数原值（0-100）"},
    {"指标代码": "fg_pct_1y", "中文名称": "恐惧贪婪-1Y%", "指标解释": "恐惧贪婪在过去1年窗口中的历史百分位"},
    {"指标代码": "fg_pct_2y", "中文名称": "恐惧贪婪-2Y%", "指标解释": "恐惧贪婪在过去2年窗口中的历史百分位"},
    {"指标代码": "fg_pct_3y", "中文名称": "恐惧贪婪-3Y%", "指标解释": "恐惧贪婪在过去3年窗口中的历史百分位"},
    {"指标代码": "fg_pct_4y", "中文名称": "恐惧贪婪-4Y%", "指标解释": "恐惧贪婪在过去4年窗口中的历史百分位"},
    {"指标代码": "fg_pct_all", "中文名称": "恐惧贪婪-ALL%", "指标解释": "恐惧贪婪在全历史中的百分位"},
    {"指标代码": "ahr999_value", "中文名称": "Ahr999", "指标解释": "Ahr999估值指标（低于0.45偏低估，高于1.2偏高估）"},
    {"指标代码": "ahr999_pct_1y", "中文名称": "Ahr999-1Y%", "指标解释": "Ahr999 在过去1年窗口的历史百分位"},
    {"指标代码": "ahr999_pct_2y", "中文名称": "Ahr999-2Y%", "指标解释": "Ahr999 在过去2年窗口的历史百分位"},
    {"指标代码": "ahr999_pct_3y", "中文名称": "Ahr999-3Y%", "指标解释": "Ahr999 在过去3年窗口的历史百分位"},
    {"指标代码": "ahr999_pct_4y", "中文名称": "Ahr999-4Y%", "指标解释": "Ahr999 在过去4年窗口的历史百分位"},
